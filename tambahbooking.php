            ...
            <div class="col-4">
                ...
                <form action="koneksi.php" method="POST">
                    <div class="form-group">
                        <label for="username">ID Booking</label>
                        <input type="text" class="form-control" id="username" name="username" required>
                    </div>
                    <div class="form-group">
                        <label for="password">ID Kamar</label>
                    ...
                    <div method="POST" action="process.php">
                        <label for="dateInput">Masukkan tanggal (YYYY-MM-DD):</label>
